...
/**
 * 鎻忚堪: 鎵弿韬唤璇佺浉鏈哄弬鏁伴厤缃�
 */
@SuppressWarnings("deprecation")
public final class CameraConfigurationManager_id {

	private static final String TAG = CameraConfigurationManager_id.class
			.getSimpleName();
	...
	public CameraConfigurationManager_id(Context context) {
