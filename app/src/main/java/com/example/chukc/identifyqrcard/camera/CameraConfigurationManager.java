...
public final class CameraConfigurationManager {
	...
	public void setDesiredCameraParameters(Camera camera) {
		...
		Size pictureSize = CamParaUtil.getInstance().getPropPictureSize(
				parameters.getSupportedPictureSizes(), DisplayUtil.getScreenRate(context), 800);
	...
	private static Point getCameraResolution(Camera.Parameters parameters,
        ...
        System.out.println("previewSizeValueString=============="+previewSizeValueString);
		if (previewSizeValueString != null) {
